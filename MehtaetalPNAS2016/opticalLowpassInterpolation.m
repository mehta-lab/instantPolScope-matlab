...
% opticalLowpassInterpolation Filter and interpolate microscopy image while
% avoiding artifacts.
%
% 
% USAGE: [out, outpix] =
...
% 
% Imaging systems (such as digital microscope or consumer camera) can
% capture spatial freuquencies only upto the cutoff determined by the
% numerical aperture of the optics and wavelength used for imaging. Any
% fine features (i.e., higher spatial frequencies) beyond that are due to
% noise. A simple and effective noise removal strategy is to remove the
% spatial frequencies above the optical cutoff.
% 
% opticalLowpassInterpolation filters the imaging data using super-gaussian
% filter in such a way that filtering artifacts are minimized.
% 
% The image can be optionally interpolated. The interplation in spatial
% domain is implemented by padding in frequency domain. This approach to
% interpolation preserves the physical variation of intensity in the image.
%
