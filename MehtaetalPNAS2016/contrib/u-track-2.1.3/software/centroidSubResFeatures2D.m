...
for i = 1 : numLocMax
    ...
    detectedFeatures.yCoord(i,:) = [ce(1) 0.2];
     detectedFeatures.amp(i,:) = [locMaxAmp(i)-bgAmp(i) 0]; % Original.
   % detectedFeatures.amp(i,:) = [locMaxAmp(i)-bgAmp(i) bgAmp(i)]; % Background returned for each particle - by Shalin.
